...
If IIPA encounters any issues during the validation of the data shared by partners, IIPA will send out ’s and the CO’s will have to communicate with the partners regarding the same.
After the, the CO can request IIPA for manually generating the missing partner’s file so that IIPA can fulfil it.they need to inform the CO and 
