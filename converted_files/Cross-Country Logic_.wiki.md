...
| Scenario | Country of Enrolment | Country of origin for Pin/Promo/Purl code (Kit enrolment) | Country of first printer purchase incase of (Kitless enrolment) | Country where Retailer has contract with HP | Compensation |
|----------|---------------------|-----------------------------------------------------------|----------------------------------------------------------------|---------------------------------------------|-------------|
...
Retailers in country_id IN ('ES','PT') do not participate in the cross-country logic.
